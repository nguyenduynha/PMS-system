...
export const PERMISSION_MODULE_LABELS: Record<string, string> = {
  ...
  HOUSEKEEPING: "Buồng phòng", MAINTENANCE: "Bảo trì",
};
...
export const PERMISSIONS: PermissionItem[] = [
  ...
  ...define("MAINTENANCE", [["VIEW", "Xem bảo trì", "Xem danh sách yêu cầu bảo trì"], ["CREATE", "Tạo bảo trì", "Tạo yêu cầu bảo trì mới"], ["UPDATE", "Cập nhật bảo trì", "Cập nhật và hoàn tất bảo trì"]]),
